...
public class MainActivity extends Activity
{
	...
	{
		bitmapIcon = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.icon_turing);
		mMenu = (SlidingMenu) findViewById(R.id.menu);
		mChatView = (ListView) findViewById(R.id.id_chat_listView);
		mMsg = (EditText) findViewById(R.id.id_chat_msg);
		mDatas.add(new ChatMessage(Type.INPUT, "你好，欢迎使用图灵聊天机器人！"));
		new MenuList(MainActivity.this, mMenu);
	}
	...
	public void bigPictureFrom(View view) {
		...
		View layout = inflater.inflate(R.layout.bigpicture, null);
		
		ImageView img = (ImageView) layout.findViewById(R.id.iv);
		img.setImageBitmap(MainActivity.bitmapIcon);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Bitmap bm = null;
        if (requestCode == MenuList.IMAGE_CODE) {
	        try {
	                //声明uri
	        ...
	        bitmapIcon = bm;
	        ((ImageView)findViewById(R.id.chat_from_icon)).setImageBitmap(bm);
		}
