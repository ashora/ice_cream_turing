...
import com.icecream.view.GestureLockView.Mode;
...
public class GestureLockViewGroup extends RelativeLayout
{
	...
	public void setmFingerUpColor(int color)
	{this.mFingerUpColor=color;}
	...
	/**
	 * 返回选择的按钮，保存到数组中，用来设置密码
	 * 
	 * @param choose
	 */
	public int[] backChoose()
	{
		int[] mPassword = new int[mChoose.size()];
		for (int i = 0; i < mChoose.size(); i++)
		{
			mPassword[i]=mChoose.get(i);
		}
		return mPassword;
	}
